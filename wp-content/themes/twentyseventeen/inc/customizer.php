...
function twentyseventeen_customize_register($wp_customize)
{
    ...
    $wp_customize->add_section('theme_test', [
        'title'    => __('Theme Test', 'twentyseventeen'),
        'priority' => 129, // Before Additional CSS.
    ]);
    $wp_customize->add_setting('control_test', [
        'default'           => 'two-column',
        'transport'         => 'refresh',
    ]);
    $wp_customize->add_control('control_test', [
        'label'           => __('Control Test', 'twentyseventeen'),
        'section'         => 'theme_test',
        'type'            => 'text',
        'default'         => '',
    ]);
...
{
    wp_enqueue_script('twentyseventeen-customize-preview', get_theme_file_uri('/assets/js/customize-preview.js'), ['customize-preview'], '1.0', true);
}
...
{
    wp_enqueue_script('twentyseventeen-customize-controls', get_theme_file_uri('/assets/js/customize-controls.js'), [], '1.0', true);
}
